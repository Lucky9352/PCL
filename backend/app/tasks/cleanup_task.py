    ...
    try:
        ...
        for article in old_articles:
            ...
            archived_article = ArchivedArticle(
                ...
                source_type=getattr(article, "source_type", None) or "inshorts",
                ...
                political_lean=article.political_lean,
                bias_score_components=article.bias_score_components,
                trust_score=article.trust_score,
                source_credibility_tier=article.source_credibility_tier,
                top_claims=article.top_claims,
                trust_score_components=article.trust_score_components,
                reliability_score=article.reliability_score,
                reliability_components=article.reliability_components,
                model_confidence=article.model_confidence,
                analysis_status=article.analysis_status,
                story_cluster_id=article.story_cluster_id,
                cluster_similarity=article.cluster_similarity,
